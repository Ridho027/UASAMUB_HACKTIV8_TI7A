...
public class PelatihanCheckoutAct extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference = FirebaseDatabase.getInstance().getReference().child("Program").child(jenis_pelatihan_baru);
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                valuehargapelatihan = Integer.valueOf(dataSnapshot.child("harga_program").getValue().toString());
            ...
            public void onClick(View v) {
                ...
                reference3.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(DataSnapshot dataSnapshot) {
                        ...
                        reference3.getRef().child("date_program").setValue(date_pelatihan);
                        reference3.getRef().child("time_program").setValue(time_pelatihan);
